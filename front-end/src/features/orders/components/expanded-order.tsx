...
const ExpandedOrder = ({ selectedOrder, setSelectedOrder }: any) => {
  return (
    <ScreenWrapper className="w-full h-full top-0 right-0 z-60 flex justify-center">
      <div
        className="bg-glass-shadow w-full h-full absolute top-0 right-0"
        onClick={() => setSelectedOrder(null)}
      ></div>
      <div className="w-[80%] h-[80%] bg-white z-10 flex flex-col justify-start overflow-y-scroll">
        <button
          onClick={() => setSelectedOrder(null)}
