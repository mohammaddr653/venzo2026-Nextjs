  ...
  return (
    <header className={`w-full max-w-screen fixed z-50`}>
      ...
      >
        ...
        <div
          className={`mobileMenu overflow-y-scroll flex flex-col md:hidden gap-5 items-stretch h-[100dvh] w-[90%] bg-white absolute transition-[left] duration-500 top-0 left-[-100%] mobmenu-open:left-0`}
        >
